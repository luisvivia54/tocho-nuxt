  ...
  <main class="bg-[#F3F4FF] text-slate-900 min-h-screen">
    <section class="pt-24 md:pt-28 lg:pt-32">
      <div class="max-w-6xl mx-auto container-pad px-6">
        ...
        <div class="mt-10">
          <h2
            class="font-display text-2xl font-extrabold mb-1 text-slate-900"
          >
            TOCHERO5LIGA 
          </h2>
        ...
        <!-- ========== PATROCINADORES · CARRUSEL OSCURO ========== -->
        <section id="patrocinadores" class="mt-12">
          <div
            class="rounded-[26px] bg-slate-900 text-slate-50 border border-slate-800 shadow-[0_20px_45px_rgba(15,23,42,0.7)] overflow-hidden"
          >
            <!-- Header -->
            <div
              class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-5 py-4 bg-gradient-to-r from-[#4F46E5] to-[#2563EB]"
            >
              <div>
                <p
              ...
              <div class="text-[11px] text-blue-50/85 text-right">
                <p>Un patrocinador destacado a la vez.</p>
                <p>Rotan automáticamente durante la temporada.</p>
              </div>
            </div>
            ...
            <div class="px-6 py-7 sm:py-8">
              <div
                class="grid lg:grid-cols-[minmax(0,1.4fr),minmax(260px,0.9fr)] gap-8 items-center"
              >
                <!-- Texto -->
                <div class="space-y-4">
                  <div
                    class="inline-flex items-center gap-2 rounded-full bg-emerald-500/15 border border-emerald-400/60 px-3 py-1.5"
                  >
                    <span
                      class="h-2 w-2 rounded-full bg-emerald-400 animate-pulse"
                    ></span>
                    <span
                      class="text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-100"
                    >
                      Patrocinador activo
                    </span>
                  </div>
                  ...
                  <div>
                    <h3
                      class="font-display text-3xl sm:text-4xl font-extrabold text-white"
                    >
                      {{ activeSponsor.name }}
                    </h3>
                    <p
                      class="mt-2 text-sm sm:text-base text-slate-100/80"
                    >
                  ...
                  <div class="flex flex-wrap items-center gap-3 mt-2">
                    <span
                      class="inline-flex items-center gap-1.5 rounded-full bg-blue-500/15 text-blue-100 border border-blue-400/60 px-3 py-1 text-[11px] font-semibold"
                    >
                      <span
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener"
                      class="inline-flex items-center gap-1.5 rounded-xl bg-blue-500 hover:bg-blue-400 px-4 py-2 text-xs sm:text-sm font-semibold text-white shadow-[0_10px_25px_rgba(37,99,235,0.5)]"
                    >
                      Visitar sitio
                ...
                <div class="flex flex-col items-center gap-5">
                  <!-- Logo grande -->
                  <div
                    class="relative w-36 h-36 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-full bg-gradient-to-tr from-blue-400 via-slate-900 to-indigo-500 flex items-center justify-center border border-slate-700 shadow-[0_0_40px_rgba(59,130,246,0.8)]"
                  >
                    <div
                      class="absolute inset-3 rounded-full bg-slate-950/80 backdrop-blur-sm"
                    />
                    <img
                    ...
                    <span
                      v-else
                      class="relative text-sm font-display font-bold text-slate-100 text-center px-4"
                    >
                      {{ activeSponsor.name }}
                    </span>
                  </div>
                  ...
                  <div class="flex flex-col items-center gap-3 w-full">
                    <div class="flex items-center justify-center gap-3">
                      <button
                        type="button"
                        class="inline-flex items-center justify-center h-9 w-9 rounded-full border border-slate-600 bg-slate-900 hover:bg-slate-800 transition"
                        @click="prevSponsor"
                      >
                        <span class="text-sm text-slate-100">&larr;</span>
                      </button>
                      ...
                      <button
                        ...
                        @click="nextSponsor"
                      >
                        <span class="text-sm text-slate-100">&rarr;</span>
                      </button>
                    </div>
              ...
              <!-- Tira de logos abajo -->
              <div class="mt-6 pt-4 border-t border-slate-700/80">
                ...
                <div class="flex gap-3 overflow-x-auto pb-1">
                  ...
                  >
                    <div
                      class="w-9 h-9 rounded-xl bg-slate-950 flex items-center justify-center overflow-hidden border border-slate-700"
                    >
                      <img
                        v-if="s.logo"
                        :src="s.logo"
...
onMounted(() => {
  // autoplay hero (solo si hay más de un slide en el futuro)

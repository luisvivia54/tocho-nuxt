<template>
  ...
  >
    ...
    <section class="relative z-10 mx-auto max-w-7xl px-4 pb-20 pt-24 sm:px-6 md:pt-28 lg:pt-32">
      <!-- Header local -->
      <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <p class="text-[11px] uppercase tracking-[0.22em] text-orange-300/80">
            Liga de Jueves · Consola Admin
          </p>
          <h1 class="text-2xl font-extrabold tracking-tight text-white md:text-3xl">Usuarios</h1>
        ...
        <div class="flex flex-wrap items-center gap-2">
          <div class="relative hidden sm:block" ref="menuWrap">
            <button
              type="button"
              class="rounded-2xl border border-white/10 bg-black/20 px-3 py-2 text-sm font-semibold text-slate-200 hover:bg-black/30 focus:outline-none focus:ring-2 focus:ring-white/20"
            ...
            >
              <div
                v-if="menuOpen"
                class="absolute right-0 mt-2 w-72 rounded-2xl overflow-hidden border border-white/10 bg-[#071225] shadow-[0_18px_45px_rgba(0,0,0,0.35)]"
                role="menu"
              >
                <div class="px-4 py-3 border-b border-white/10">
                  <p class="text-[11px] uppercase tracking-[0.22em] text-orange-300 font-extrabold">Panel Admin</p>
                ...
                <div class="p-2 grid gap-1">
                  <NuxtLink
                    to="/jueves/admin"
                    class="menu-item"
                    :class="isActive('/jueves/admin') ? 'menu-item--active' : ''"
                    @click="menuOpen = false"
                  >
                    <div class="min-w-0">
                      <p class="font-extrabold text-white truncate">Inicio</p>
                      <p class="text-[11px] text-slate-400 truncate">Editar home</p>
                    </div>
                  </NuxtLink>
                  ...
                  <NuxtLink
                    ...
                    class="menu-item"
                    :class="isActive('/jueves/admin/partidos') ? 'menu-item--active' : ''"
                    @click="menuOpen = false"
                  >
                    <div class="min-w-0">
                      <p class="font-extrabold text-white truncate">Partidos</p>
                      <p class="text-[11px] text-slate-400 truncate">Administración</p>
                    </div>
                  </NuxtLink>
                  ...
                  <NuxtLink
                    ...
                    class="menu-item"
                    :class="isActive('/jueves/admin/usuarios') ? 'menu-item--active' : ''"
                    @click="menuOpen = false"
                  >
                    <div class="min-w-0">
                      <p class="font-extrabold text-white truncate">Usuarios</p>
                      <p class="text-[11px] text-slate-400 truncate">Roles / acceso</p>
                    </div>
                  </NuxtLink>
                  ...
                  <NuxtLink
                    ...
                    class="menu-item"
                    :class="isActive('/jueves/admin/jugadores') ? 'menu-item--active' : ''"
                    @click="menuOpen = false"
                  >
                    <div class="min-w-0">
                      <p class="font-extrabold text-white truncate">Jugadores</p>
                      <p class="text-[11px] text-slate-400 truncate">Gestión</p>
                    </div>
                  </NuxtLink>
                  ...
                  <NuxtLink
                    ...
                    class="menu-item"
                    :class="isActive('/jueves/admin/equipos') ? 'menu-item--active' : ''"
                    @click="menuOpen = false"
                  >
                    <div class="min-w-0">
                      <p class="font-extrabold text-white truncate">Equipos</p>
                      <p class="text-[11px] text-slate-400 truncate">Borrar / limpiar</p>
                    </div>
                  </NuxtLink>
                  ...
                  >
                    <div class="min-w-0">
                      <p class="font-extrabold text-white truncate">Ver sitio</p>
                      <p class="text-[11px] text-slate-400 truncate">Página pública jueves</p>
                    </div>
                  </NuxtLink>
                </div>
              </div>
      ...
      <!-- Hero resumen -->
      <div class="mt-5 rounded-[30px] border border-white/10 bg-gradient-to-br from-white/8 to-white/4 p-5 shadow-[0_18px_40px_rgba(0,0,0,0.28)]">
...
function isActive(path: string) {
  if (path === "/jueves/admin") return route.path === "/jueves/admin"

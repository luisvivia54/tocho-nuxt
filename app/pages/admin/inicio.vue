...
<template>
            ...
            <section class="card">
              ...
              <div class="card-b space-y-4">
                ...
                <div class="grid sm:grid-cols-2 gap-3">
                  <div class="mini">
                    <p class="mini-h">Botón 1</p>
                    <label class="lbl">Texto</label>
                    <input v-model="model.hero.cta1.label" class="in" type="text" placeholder="Ver estadísticas" />
                    <label class="lbl mt-2">Ruta</label>
                    <input v-model="model.hero.cta1.to" class="in" type="text" placeholder="/estadisticas" />
                  </div>
  
                  <div class="mini">
                    <p class="mini-h">Botón 2</p>
                    <label class="lbl">Texto</label>
                    <input v-model="model.hero.cta2.label" class="in" type="text" placeholder="Registrar equipo" />
                    <label class="lbl mt-2">Ruta</label>
                    <input v-model="model.hero.cta2.to" class="in" type="text" placeholder="/registro" />
                  </div>
                </div>
  ...
  type Sponsor = { id: string; name: string; logo: string; url: string }
  ...
  const model = reactive<HomeSimple>(clone(DEFAULTS))
  ...
  function safeApplyParsed(parsed: any): HomeSimple {
    const merged: HomeSimple = clone(DEFAULTS)
    ...
    if (parsed && typeof parsed === 'object') {
      if (parsed.hero && typeof parsed.hero === 'object') {
        ...
        if (Array.isArray(parsed.hero.images)) merged.hero.images = parsed.hero.images
      }
      ...
      if (Array.isArray(parsed.sponsors)) merged.sponsors = parsed.sponsors
  ...
  /* HERO: add/move/remove (FIX TS: swap sin destructuring) */
  ...
  /* Sponsors: add/move/remove (FIX TS: swap sin destructuring) */
  function addSponsor() {
  ...
  const heroPreview = computed<HeroImage | null>(() => {
